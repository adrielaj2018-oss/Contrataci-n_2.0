...
# Gestión de Contratación habilitada como único módulo activo.
...
# Ejemplo Windows: si app.py está en D:\MiSistema\, se crea D:\MiSistema\DOCUMENTOS_PORTAL HR_AUTO\
# En Render también se crea dentro del proyecto, pero para carga real masiva se recomienda uso local.
DOCUMENTOS_BASE_DIR = Path(os.getenv("DOCUMENTOS_BASE_DIR", str(BASE_DIR / "DOCUMENTOS_PORTAL HR_AUTO")))
...
def sincronizar_documentos_carpeta(dni=None, devolver_resumen=False):
    # Detecta documentos desde DOCUMENTOS_PORTAL HR_AUTO, incluyendo:
...
.app{background:var(--bg)!important}.main{background:linear-gradient(135deg,#f7fbff 0%,#edf4f8 45%,#e9f1f6 100%)!important;color:var(--ink)!important;padding-top:32px!important}.hero{background:transparent!important;border-bottom:0!important;padding-top:10px!important}.topbar h1,.c-title{color:var(--ink)!important;text-shadow:none!important;letter-spacing:-.7px!important;font-weight:800!important}.subtitle,.muted,.muted2{color:#687589!important}
...
.card,.c-card,.filter-card,.create-card{background:rgba(255,255,255,.96)!important;color:var(--ink)!important;border:1px solid var(--border)!important;border-radius:22px!important;box-shadow:0 18px 42px rgba(9,46,75,.10)!important}.c-card h2,.c-card h3,.card h2,.card h3{color:var(--ink)!important}.input,input,select,textarea{background:#fff!important;color:var(--ink)!important;border:1.5px solid #c5d2df!important;border-radius:14px!important;font-weight:800!important;box-shadow:none!important}input:focus,select:focus,textarea:focus{border-color:var(--accent)!important;box-shadow:0 0 0 4px rgba(22,163,74,.18)!important;outline:none!important}option{background:#fff!important;color:var(--ink)!important}.c-btn,.btn,.btn-blue,.btn-green,.crear-btn{background:linear-gradient(135deg,var(--accent2),var(--accent))!important;color:#061a33!important;border:0!important;border-radius:16px!important;font-weight:800!important;box-shadow:0 12px 28px rgba(22,163,74,.28)!important}.c-btn.gray,.btn.gray,.gray{background:#6b7788!important;color:#fff!important;box-shadow:none!important}.btn-red{background:#ffe8e8!important;color:#b42318!important;border:1px solid #ffc8c8!important}.state-pill.ok,.status-pill,.pill.ok{background:#fff7d1!important;color:#8a5a00!important;border:1px solid #ffd66b!important}.state-pill.bad{background:#ffe8e8!important;color:#b42318!important;border:1px solid #ffc8c8!important}
.table-wrap{background:#fff!important;border:1px solid var(--border)!important;border-radius:20px!important;box-shadow:0 16px 36px rgba(9,46,75,.08)!important}table,.c-table,.tpl-table{background:#fff!important;color:var(--ink)!important;border-collapse:separate!important;border-spacing:0!important}.c-table th,.tpl-table th,th{background:#e9f1f7!important;color:#15304a!important;border-bottom:1px solid #cfdae6!important;text-transform:uppercase!important;letter-spacing:.04em!important;font-weight:800!important}.c-table td,.tpl-table td,td{background:#fff!important;color:#13263e!important;border-bottom:1px solid #e1e8f0!important;font-weight:850!important}.c-table tr:nth-child(even) td,.tpl-table tr:nth-child(even) td{background:#f7fafc!important}.plantilla-table td:nth-child(n+4),.plantilla-table td:nth-child(n+4) *{color:#31445a!important;opacity:1!important}.plantilla-table td:nth-child(3){color:#061a33!important;font-weight:800!important}.plantilla-filter{display:grid!important;grid-template-columns:180px 1fr 210px 1fr!important;gap:18px 22px!important;align-items:center!important}.plantilla-filter b,.c-form b{color:var(--ink)!important;font-weight:800!important}.plantilla-top{display:flex!important;align-items:center!important;justify-content:space-between!important;margin-bottom:28px!important}.plantilla-top .crear-btn{padding:18px 30px!important;border-radius:999px!important;font-size:17px!important}
...
.side .menu-title,.side .menu-title *,.side .menu-item,.side .menu-item *{color:#f1f5f9!important;font-weight:800!important;letter-spacing:.01em!important;}
...
body{background:#eef2f5!important;color:#0f172a!important;font-weight:800!important;text-rendering:geometricPrecision!important;-webkit-font-smoothing:antialiased!important}.main{background:#eef2f5!important;color:#0f172a!important}.hero,.card,.mini,.metric,.stat,.module-tile,.dashboard-panel,.gestion-card{background:#fff!important;border:1px solid #dbe5ee!important;color:#0f172a!important;box-shadow:0 14px 36px rgba(15,23,42,.10)!important;border-radius:24px!important}.hero h1,.topbar h1,.card h2,.module-tile h2,.admin-title h1{color:#0f172a!important;font-weight:800!important}.subtitle,.muted,.muted2{color:#64748b!important}.accent,.mini b{color:#15945a!important}.btn,.btn-blue,.btn-green,.btn-warn,.btn-yellow,.c-btn,.full-link{background:linear-gradient(135deg,#19aa63,#0f8f55)!important;color:#fff!important;border:0!important;border-radius:14px!important;font-weight:800!important;box-shadow:0 12px 24px rgba(22,163,74,.20)!important}.input,select,textarea,input[type=file]{background:#fff!important;color:#111827!important;border:1px solid #d5e1ec!important;border-radius:14px!important}.input:focus,select:focus,textarea:focus,input:focus{border-color:#19aa63!important;box-shadow:0 0 0 4px rgba(22,163,74,.14)!important}th{background:#f3f7fb!important;color:#334155!important}td{color:#1f2937!important}.side{background:linear-gradient(180deg,#124f34,#0e322d 42%,#091827)!important}.side-top{background:#124f34!important}.brand:before{content:'PORTAL HR PRO'!important;color:#fff!important;font-size:22px!important;font-weight:800!important}.brand p{font-size:0!important}.brand p:before{content:'Actualización de Datos';font-size:13px!important;color:#d1fae5!important;font-weight:800!important}.menu-title,.menu-item{color:#d7e1ea!important;font-weight:800!important}.menu-title:hover,.menu-item:hover{background:rgba(255,255,255,.09)!important;color:#fff!important}.menu-item.active,.menu-title.active,.menu-group.force-open>.menu-title.active{background:linear-gradient(135deg,#17aa55,#158a48)!important;color:#fff!important;box-shadow:0 14px 28px rgba(0,0,0,.20)!important}.login-body{background:radial-gradient(circle at 9% 5%,rgba(34,197,94,.18) 0 19%,transparent 19.4%),radial-gradient(circle at 94% 0%,rgba(20,184,166,.18) 0 20%,transparent 20.4%),linear-gradient(180deg,#f8fafc 0%,#ecfdf5 100%)!important}.login-body:after{content:'';position:absolute;left:-4%;right:-4%;bottom:-6%;height:31%;background:linear-gradient(135deg,#22c55e,#064e3b);clip-path:polygon(0 38%,25% 22%,50% 15%,75% 25%,100% 35%,100% 100%,0 100%);z-index:0}.login-card{width:min(92vw,560px)!important;padding:88px 56px 34px!important;overflow:visible!important;text-align:left!important;background:rgba(255,255,255,.96)!important;position:relative!important;z-index:2!important;border-radius:26px!important;border:1px solid #dbe5ee!important;box-shadow:0 22px 55px rgba(15,23,42,.13)!important}.login-card:before{content:'👥'!important;position:absolute!important;left:50%!important;top:-68px!important;transform:translateX(-50%)!important;width:136px!important;height:136px!important;border-radius:50%!important;background:#fff!important;border:1px solid #dbe5ee!important;color:#149459!important;display:grid!important;place-items:center!important;font-size:52px!important;box-shadow:0 22px 55px rgba(15,23,42,.13)!important}.login-card:after{display:none!important}.login-logo{display:none!important}.login-title h1{color:#1f2937!important;font-size:38px!important;letter-spacing:1px!important;text-align:center!important}.login-title b{color:#64748b!important;font-size:17px!important;display:block;text-align:center!important}.login-title:after{content:'';display:block;margin:20px auto 0;width:62px;height:4px;border-radius:999px;background:#10b981}.login-input{background:#eaf2ff!important;border:1px solid #cfe0f2!important;border-radius:16px!important;padding:0 14px!important;margin-bottom:20px!important;color:#149459!important}.login-input input,.login-input select{background:transparent!important;color:#0f172a!important;border:0!important}.login-card .field label{display:block!important;color:#111827!important;margin:10px 0 8px;font-weight:1000}.login-card .btn-green{width:100%!important;margin:0 0 28px!important;font-size:18px!important;border-radius:16px!important;padding:17px!important}.login-links{margin-top:0!important;padding-bottom:0!important}.login-links a{color:#64748b!important}
...
h1,h2,h3,.hero h1,.topbar h1,.card h2,.module-tile h2,.admin-title h1{font-weight:700!important;letter-spacing:-.035em!important;color:#111827!important;line-height:1.12!important}
...
.login-card .btn-green{width:100%!important;height:64px!important;border-radius:18px!important;background:linear-gradient(135deg,#1fac67,#0f8f55)!important;color:#fff!important;font-size:18px!important;font-weight:700!important;display:flex!important;align-items:center!important;justify-content:center!important;margin:18px 0 22px!important;border:0!important;box-shadow:0 15px 30px rgba(22,163,74,.26)!important}
...
.side-brand-text b{font-weight:700!important;color:#fff!important}.side-brand-text small{font-weight:570!important;color:#cbd5e1!important}.side-brand-icon{color:#d9f7e8!important;background:rgba(255,255,255,.12)!important}.toggle{color:#eaf8f1!important;background:rgba(255,255,255,.10)!important}
...
.login-card .btn-green{width:100%!important;height:58px!important;border-radius:17px!important;background:linear-gradient(135deg,#1fac67,#0f8f55)!important;color:#fff!important;font-size:19px!important;font-weight:700!important;display:flex!important;align-items:center!important;justify-content:center!important;margin:16px 0 20px!important;border:0!important;box-shadow:0 14px 28px rgba(22,163,74,.24)!important}.login-links{margin:0!important;padding:0!important;text-align:center!important}.login-links a{font-size:14px!important;color:#667085!important;font-weight:650!important;text-decoration:none!important}
@media(max-width:700px){.login-body{padding:82px 12px 108px!important;align-items:center!important;overflow-y:auto!important}.login-card{width:calc(100vw - 26px)!important;max-width:420px!important;padding:82px 26px 30px!important;border-radius:26px!important}.login-logo{top:-62px!important}.login-avatar-svg{width:124px!important;height:124px!important}.login-title h1{font-size:31px!important}.login-title b{font-size:17px!important;max-width:310px!important;margin:auto!important}.login-input{height:58px!important}.login-input input,.login-input select{height:46px!important;min-height:46px!important;font-size:17px!important}.login-card .btn-green{height:60px!important;font-size:18px!important}.login-body:after{font-size:12px!important;bottom:14px!important}}
...
.login-input input:-webkit-autofill{-webkit-box-shadow:0 0 0 1000px #fff inset!important;-webkit-text-fill-color:#172033!important;caret-color:#172033!important;}
.login-card .btn-green{width:100%!important;height:58px!important;border-radius:17px!important;font-size:19px!important;font-weight:700!important;margin:16px 0 20px!important;}
...
.menu-title,.menu-item{color:#eaf7f1!important;opacity:1!important;text-shadow:none!important;font-weight:700!important;}
...
@media(max-width:1000px){
  ...
  .menu-title,.menu-item{font-size:13.5px!important;color:#f8fffc!important;font-weight:700!important;}
...
.login-card .btn-green{
  ...
  color:#fff!important;font-size:19px!important;font-weight:700!important;display:flex!important;align-items:center!important;justify-content:center!important;
...
@media(max-width:700px){
  ...
  .login-card .btn-green{height:60px!important;font-size:18px!important;}
  .login-body:after{font-size:12px!important;bottom:14px!important;}
}
...
def sidebar(active):
    """Menú PRO: Gestión Documental + Gestión de Contratación, sin módulos que no corresponden."""
    active_txt = str(active or '')
    active_type = active_txt.split(':', 1)[0]
    active_sub = active_txt.split(':', 1)[1] if ':' in active_txt else ''

    def link_doc(tipo, label, icon):
        cls = 'menu-item active' if active_type == tipo else 'menu-item'
        return f"<a class='{cls}' onclick='saveSideScroll()' href='{url_for('panel_tipo', tipo=tipo)}'><span>{icon}</span><span class='label'>{label}</span></a>"

    pago = ''.join(link_doc(k, l, i) for k, l, i in TIPOS_PAGO)
    emp = ''.join(link_doc(k, l, i) for k, l, i in TIPOS_EMPRESA)
    per = ''.join(link_doc(k, l, i) for k, l, i in TIPOS_PERSONALES)
    docs_keys = [k for k,_,_ in TIPOS_PAGO] + [k for k,_,_ in TIPOS_EMPRESA] + [k for k,_,_ in TIPOS_PERSONALES] + ['Modulo documentos','Subir documentos','Admin','Trabajadores','Usuarios']
    docs_open = ' force-open' if active_type in docs_keys else ''
    docs_head = ' active' if active_type in docs_keys else ''
    con_open = ' force-open' if active_type == 'Gestion Contratacion' else ''
    con_head = ' active' if active_type == 'Gestion Contratacion' else ''
    cuenta_active = ' active' if active_type == 'Inicio' else ''

    if session.get('admin_id'):
        return f"""
        <nav>
          <div id='grp_admin_doc' data-group='admin_doc' class='menu-group{docs_open}'>
            <button type='button' class='menu-title{docs_head}' onclick="toggleGroup('grp_admin_doc')"><i class='bi bi-folder2-open'></i><span class='label'>Gestión Documental</span><span class='chev'>∨</span></button>
            <div class='submenu'>
              <a class='menu-item {'active' if active_type == 'Admin' else ''}' onclick='saveSideScroll()' href='/admin'><i class='bi bi-speedometer2'></i><span class='label'>Dashboard</span></a>
              <a class='menu-item {'active' if active_type == 'Modulo documentos' else ''}' onclick='saveSideScroll()' href='/admin/modulo/documentos'><i class='bi bi-grid'></i><span class='label'>Dashboard documental</span></a>
              <div class='menu-group nested force-open'>
                <button type='button' class='menu-title' onclick="toggleGroup('grp_pago')"><i class='bi bi-receipt'></i><span class='label'>Documentos de pago</span><span class='chev'>∨</span></button>
                <div id='grp_pago' class='submenu'>{pago}</div>
              </div>
              <div class='menu-group nested'>
                <button type='button' class='menu-title' onclick="toggleGroup('grp_empresa')"><i class='bi bi-building-check'></i><span class='label'>Documentos empresa</span><span class='chev'>∨</span></button>
                <div id='grp_empresa' class='submenu'>{emp}</div>
              </div>
              <div class='menu-group nested'>
                <button type='button' class='menu-title' onclick="toggleGroup('grp_personal')"><i class='bi bi-person-vcard'></i><span class='label'>Documentos personales</span><span class='chev'>∨</span></button>
                <div id='grp_personal' class='submenu'>{per}</div>
              </div>
              <a class='menu-item {'active' if active_type == 'Subir documentos' else ''}' onclick='saveSideScroll()' href='/admin/documentos'><i class='bi bi-cloud-arrow-up'></i><span class='label'>Subir / gestionar</span></a>
              <a class='menu-item {'active' if active_type == 'Trabajadores' else ''}' onclick='saveSideScroll()' href='/admin/trabajadores'><i class='bi bi-people'></i><span class='label'>Trabajadores</span></a>
              <a class='menu-item {'active' if active_type == 'Usuarios' else ''}' onclick='saveSideScroll()' href='/admin/usuarios'><i class='bi bi-shield-lock'></i><span class='label'>Usuarios</span></a>
              <a class='menu-item' onclick='saveSideScroll()' href='/admin/plantilla_gestion/documental'><i class='bi bi-file-earmark-excel'></i><span class='label'>Plantilla Documental</span></a>
            </div>
          </div>
          <div id='grp_admin_contratacion' data-group='admin_contratacion' class='menu-group{con_open}'>
            <button type='button' class='menu-title{con_head}' onclick="toggleGroup('grp_admin_contratacion')"><i class='bi bi-briefcase'></i><span class='label'>Gestión de Contratación</span><span class='chev'>∨</span></button>
            <div class='submenu'>
              <a class='menu-item {'active' if active_type == 'Gestion Contratacion' and active_sub in ['', 'dashboard'] else ''}' onclick='saveSideScroll()' href='/admin/contratacion'><i class='bi bi-speedometer2'></i><span class='label'>Dashboard contratación</span></a>
              <a class='menu-item {'active' if active_sub == 'plantillas' else ''}' onclick='saveSideScroll()' href='/admin/contratacion?sec=plantillas'><i class='bi bi-file-earmark-word'></i><span class='label'>Plantillas documentos</span></a>
              <a class='menu-item {'active' if active_sub == 'carga' else ''}' onclick='saveSideScroll()' href='/admin/contratacion?sec=carga'><i class='bi bi-cloud-arrow-up'></i><span class='label'>Carga masiva</span></a>
              <a class='menu-item {'active' if active_sub == 'reportes' else ''}' onclick='saveSideScroll()' href='/admin/contratacion?sec=reportes'><i class='bi bi-bar-chart-line'></i><span class='label'>Reportes</span></a>
              <a class='menu-item {'active' if active_sub == 'maestros' else ''}' onclick='saveSideScroll()' href='/admin/contratacion?sec=maestros'><i class='bi bi-gear'></i><span class='label'>Datos maestros</span></a>
              <a class='menu-item {'active' if active_sub == 'firma' else ''}' onclick='saveSideScroll()' href='/admin/contratacion?sec=firma'><i class='bi bi-fingerprint'></i><span class='label'>Firma / Facial</span></a>
            </div>
          </div>
          <div id='grp_cuenta' data-group='cuenta' class='menu-group'>
            <button type='button' class='menu-title' onclick="toggleGroup('grp_cuenta')"><i class='bi bi-person-circle'></i><span class='label'>Cuenta</span><span class='chev'>∨</span></button>
            <div class='submenu'><a class='menu-item' href='/logout'><i class='bi bi-box-arrow-right'></i><span class='label'>Salir</span></a></div>
          </div>
        </nav>"""

    docs_user_open = ' force-open' if active_type in [k for k,_,_ in TIPOS_PAGO] + [k for k,_,_ in TIPOS_EMPRESA] + [k for k,_,_ in TIPOS_PERSONALES] + ['Inicio'] else ''
    return f"""
    <nav>
      <div id='grp_user_doc' data-group='user_doc' class='menu-group{docs_user_open}'>
        <button type='button' class='menu-title active' onclick="toggleGroup('grp_user_doc')"><i class='bi bi-folder2-open'></i><span class='label'>Gestión Documental</span><span class='chev'>∨</span></button>
        <div class='submenu'>
          <a class='menu-item{cuenta_active}' onclick='saveSideScroll()' href='/panel'><i class='bi bi-speedometer2'></i><span class='label'>Dashboard documental</span></a>
          <div class='menu-group nested force-open'><button type='button' class='menu-title' onclick="toggleGroup('grp_pago_user')"><i class='bi bi-receipt'></i><span class='label'>Documentos de pago</span><span class='chev'>∨</span></button><div id='grp_pago_user' class='submenu'>{pago}</div></div>
          <div class='menu-group nested'><button type='button' class='menu-title' onclick="toggleGroup('grp_empresa_user')"><i class='bi bi-building-check'></i><span class='label'>Documentos empresa</span><span class='chev'>∨</span></button><div id='grp_empresa_user' class='submenu'>{emp}</div></div>
          <div class='menu-group nested'><button type='button' class='menu-title' onclick="toggleGroup('grp_personal_user')"><i class='bi bi-person-vcard'></i><span class='label'>Documentos personales</span><span class='chev'>∨</span></button><div id='grp_personal_user' class='submenu'>{per}</div></div>
        </div>
      </div>
      <div id='grp_user_contratacion' data-group='user_contratacion' class='menu-group{con_open}'>
        <button type='button' class='menu-title{con_head}' onclick="toggleGroup('grp_user_contratacion')"><i class='bi bi-briefcase'></i><span class='label'>Gestión de Contratación</span><span class='chev'>∨</span></button>
        <div class='submenu'><a class='menu-item {'active' if active_type == 'Gestion Contratacion' else ''}' onclick='saveSideScroll()' href='/contratacion/mis_documentos'><i class='bi bi-folder-check'></i><span class='label'>Mis contratos</span></a></div>
      </div>
      <div class='menu-group'><a class='menu-item' href='/logout'><i class='bi bi-box-arrow-right'></i><span class='label'>Salir</span></a></div>
    </nav>"""
...
@worker_required
def panel():
    return redirect(url_for('trabajador_contratacion'))
...
def contratacion_plantilla_detalle(pid):
    ...
    <style>
      ...
      .contract-detail-wrap .tpl-line,.contract-detail-wrap .tpl-line span{{color:#334155!important;font-weight:800!important}}
      .contract-detail-wrap .tpl-line b{{color:#0f172a!important;font-weight:800!important}}
...
@media(max-width:1000px){{
  ...
  .menu-title,.menu-item{{color:#f1f7f5!important;opacity:1!important;text-shadow:none!important;font-weight:700!important;}}
...
# ===== FIX PRODUCCIÓN RENDER: sin bucle de redirección + login letras suaves =====
@app.after_request
def fix_render_redirect_login_suave(response):
    try:
        ct = response.headers.get('Content-Type','')
        if 'text/html' not in ct.lower():
            return response
        html_text = response.get_data(as_text=True)
        html_text = html_text.replace('PORTAL HR PRO', 'PORTAL HR PRO').replace('Portal HR Pro', 'Portal HR Pro')
        css = '''<style id="fix-render-final-urgente">
        .login-title h1{font-weight:700!important;font-size:34px!important;letter-spacing:-.025em!important;color:#182233!important;}
        .login-title b{font-weight:440!important;color:#7a8697!important;font-size:15.5px!important;}
        .login-card .field label{font-weight:600!important;color:#273244!important;}
        .login-input input,.login-input select{font-weight:440!important;color:#172033!important;-webkit-text-fill-color:#172033!important;}
        .login-card .btn-green{font-weight:650!important;}
        .login-links a{font-weight:520!important;}
        .login-body:after{content:"🛡️  Sistema seguro y confiable\A © 2025 Portal HR Pro. Todos los derechos reservados."!important;font-weight:520!important;}
        .side-brand-text b{font-weight:700!important;}.side-brand-text small{font-weight:500!important;}.menu-title,.menu-item{font-weight:570!important;}
        @media(max-width:700px){.login-title h1{font-size:30px!important;font-weight:700!important}.login-title b{font-size:15.5px!important;font-weight:440!important}}
        </style>'''
        html_text = html_text.replace('</head>', css + '</head>')
        response.set_data(html_text)
        response.headers['Content-Length'] = str(len(response.get_data()))
