...
/* === FIX FINAL 1.0 - TEMA CLARO SUAVE DESPUES DEL LOGIN === */
:root{--txt:#0f172a!important;--mut:#64748b!important;--yellow:#16a34a!important;--yellow2:#15965a!important;--dark:#eef2f5!important;--panel:#ffffff!important;--panel2:#f8fafc!important;--line:#dbe5ee!important;--shadow:0 18px 45px rgba(15,23,42,.10)!important}
body{background:#eef2f5!important;color:#0f172a!important;font-weight:650!important}.app{background:#eef2f5!important}.main{background:radial-gradient(circle at 95% -8%,rgba(16,185,129,.12),transparent 24%),linear-gradient(180deg,#f8fbfd 0%,#eef6f3 100%)!important;color:#0f172a!important;padding:0 34px 50px!important}.hero{background:#ffffff!important;border:1px solid #dbe5ee!important;border-radius:0 0 28px 28px!important;box-shadow:0 16px 38px rgba(15,23,42,.08)!important}.topbar h1,.hero h1,.card h2,h1,h2,h3{color:#0f172a!important;text-shadow:none!important}.subtitle,.muted,.empty-note,.alert-item span{color:#64748b!important}.card,.mini,.doc-card,.detail-box,.alert-card,.module-card,.module-tile,.metric,.stat{background:#ffffff!important;border:1px solid #dbe5ee!important;color:#0f172a!important;box-shadow:0 14px 36px rgba(15,23,42,.10)!important;border-radius:22px!important}.doc-card:before{background:rgba(34,197,94,.14)!important}.doc-card h3,.card b,.mini b{color:#0f172a!important}.mini b,.accent{color:#148a51!important}.ico,.bell{background:linear-gradient(135deg,#d8fbe4,#bbf7d0)!important;color:#107044!important;box-shadow:none!important}.btn,.btn-blue,.btn-green{background:linear-gradient(135deg,#19aa63,#0f8f55)!important;color:#fff!important;border:0!important;border-radius:14px!important;box-shadow:0 12px 24px rgba(22,163,74,.18)!important}.btn-red{border:0!important;border-radius:14px!important}.input,select,textarea,.field input,.field select,.field textarea,input[type=file]{background:#fff!important;color:#111827!important;border:1px solid #d5e1ec!important;border-radius:14px!important;box-shadow:none!important}.input:focus,select:focus,textarea:focus,.field input:focus,.field select:focus,.field textarea:focus{border-color:#19aa63!important;box-shadow:0 0 0 4px rgba(22,163,74,.14)!important}.field label{color:#344054!important}.table-wrap{background:#fff!important;border:1px solid #dbe5ee!important;border-radius:18px!important}table{background:#fff!important;color:#243042!important}th{background:#f3f7fb!important;color:#334155!important;border-bottom:1px solid #dbe5ee!important}td{background:#fff!important;color:#1f2937!important;border-bottom:1px solid #e5edf4!important}tr:hover td{background:#f8fafc!important}.flash{background:#dff7e9!important;color:#064e3b!important;border-color:#9adbb8!important}.flash.err{background:#fee2e2!important;color:#991b1b!important;border-color:#fecaca!important}
.side{background:linear-gradient(180deg,#124f34,#0e322d 46%,#091827)!important;color:#f8fafc!important;border-right:1px solid rgba(255,255,255,.12)!important;box-shadow:16px 0 36px rgba(15,23,42,.22)!important}.side-top{background:#124f34!important;border-bottom:1px solid rgba(255,255,255,.12)!important}.brand img{display:none!important}.brand:before{content:'PORTAL HR PRO';display:block;color:#fff;font-size:22px;font-weight:1000;letter-spacing:.3px}.brand p{color:#d1fae5!important;font-weight:850!important}.menu-title,.menu-item{background:transparent!important;border:0!important;color:#d7e1ea!important;box-shadow:none!important;border-radius:16px!important;font-weight:850!important;text-shadow:none!important}.menu-title:hover,.menu-item:hover{background:rgba(255,255,255,.09)!important;color:#fff!important}.menu-item.active,.menu-title.active,.menu-group.force-open>.menu-title.active{background:linear-gradient(135deg,#17aa55,#158a48)!important;color:#fff!important;box-shadow:0 14px 28px rgba(0,0,0,.20)!important}.menu-group.force-open>.menu-title{background:rgba(255,255,255,.08)!important;color:#fff!important}.side-user{background:rgba(255,255,255,.10)!important;color:#fff!important;border:1px solid rgba(255,255,255,.12)!important;border-radius:20px!important}.side-user small{color:#b7f7d1!important}.avatar{background:#22c55e!important;color:#fff!important}.mobile-head{background:#124f34!important;color:#fff!important}.login-body{background:linear-gradient(180deg,#f8fafc 0%,#ecfdf5 100%)!important}.login-card{background:rgba(255,255,255,.96)!important;color:#0f172a!important}.login-title h1{color:#1f2937!important}.login-title b{color:#64748b!important}@media(max-width:1000px){.main{padding:0 14px 30px!important}.hero{border-radius:0 0 22px 22px!important}.side{background:linear-gradient(180deg,#124f34,#0e322d 46%,#091827)!important}}
/* Contratacion: plantillas y datos maestros en claro */
.c-title{color:#0f172a!important;font-weight:900!important}.c-card,.filter-card,.table-wrap{background:#fff!important;border:1px solid #dbe5ee!important;color:#0f172a!important;box-shadow:0 14px 36px rgba(15,23,42,.10)!important;border-radius:22px!important}.c-filter input,.c-filter select,.c-form input,.c-form select,.c-form textarea{background:#fff!important;color:#111827!important;border:1px solid #d5e1ec!important;border-radius:14px!important}.c-table{background:#fff!important;color:#1f2937!important}.c-table th{background:#f3f7fb!important;color:#334155!important;border-color:#dbe5ee!important}.c-table td{background:#fff!important;color:#1f2937!important;border-color:#e5edf4!important}.c-table tr:nth-child(even) td{background:#fbfdff!important}.plantilla-table td,.plantilla-table td *{color:#1f2937!important;opacity:1!important}.plantilla-table th{color:#334155!important}.tpl-link{color:#0f172a!important}.icon-btn{color:#148a51!important}.state-select,.state{background:#fff!important;color:#148a51!important;border:1px solid #16a34a!important}.c-btn{background:linear-gradient(135deg,#19aa63,#0f8f55)!important;color:#fff!important;border:0!important;border-radius:14px!important;font-weight:900!important}.c-btn.gray{background:#eef2f7!important;color:#334155!important}.ficha-profile,.avatar-panel,.profile-main,.profile-col,.periodos-box{background:#fff!important;border:1px solid #dbe5ee!important;color:#0f172a!important}.profile-main h2,.profile-main p,.profile-col p,.laboral-grid label{color:#0f172a!important}.ficha-tabs .tab{color:#64748b!important}.ficha-tabs .tab.active{color:#148a51!important;border-bottom-color:#16a34a!important}.created-box{background:#f8fafc!important;border:1px solid #dbe5ee!important;color:#475569!important}
