    ...
    if request.method=='POST':
        ...
        if accion == 'registrar_dni_requerimiento':
            ...
            with db() as con:
                ...
                con.commit()
            flash('DNI conectado al requerimiento. Si existe, se marca como REINGRESANTE; si no, queda como NUEVO para completar ficha.', 'ok')
            return redirect(url_for('admin_contratacion', sec='requerimientos'))
