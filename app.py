...
# Ejemplo Windows: si app.py está en D:\MiSistema\, se crea D:\MiSistema\DOCUMENTOS_PORTAL HR PRO_AUTO\
# En Render también se crea dentro del proyecto, pero para carga real masiva se recomienda uso local.
DOCUMENTOS_BASE_DIR = Path(os.getenv("DOCUMENTOS_BASE_DIR", str(BASE_DIR / "DOCUMENTOS_PORTAL HR PRO_AUTO")))
    ...
    with db() as con:
        ...
        if not con.execute("SELECT 1 FROM usuarios_admin WHERE usuario='admin'").fetchone():
            con.execute("INSERT INTO usuarios_admin(usuario,clave_hash,nombre,rol) VALUES(?,?,?,?)",
                        ("admin", generate_password_hash("admin123"), "Administrador PORTAL HR PRO", "admin"))
...
def sincronizar_documentos_carpeta(dni=None, devolver_resumen=False):
    # Detecta documentos desde DOCUMENTOS_PORTAL HR PRO_AUTO, incluyendo:
...
.login-input:focus-within{background:rgba(21,153,71,.10);border-color:rgba(21,153,71,.72);box-shadow:0 0 0 4px rgba(21,153,71,.12)}
...
.form-grid{grid-template-columns:repeat(12,1fr);align-items:end}.form-grid .field{grid-column:span 3}.form-grid .field:nth-child(4n+1){grid-column:span 3}.form-grid button,.form-grid .btn,.form-grid .btn-blue,.form-grid .btn-green{grid-column:span 3;justify-content:center;height:54px}.field label{display:block;margin-bottom:8px;color:#eaf0f7;font-size:13px;letter-spacing:.3px}.field input,.field select,.field textarea,.input,select,textarea{background:#0f1319;border:1px solid #3b414b;color:#fff;border-radius:14px;min-height:48px;padding:12px 14px;font-weight:800}.field input:focus,.field select:focus,.field textarea:focus,.input:focus,select:focus,textarea:focus{border-color:var(--yellow);box-shadow:0 0 0 4px rgba(21,153,71,.12);outline:none}.card form{gap:18px}.alert-card{background:linear-gradient(145deg,#202329,#16191e 65%,rgba(21,153,71,.06));}.alert-item{display:grid;grid-template-columns:48px 1fr auto;gap:12px;align-items:center;padding:13px 0;border-top:1px solid #323740}.alert-item:first-of-type{border-top:0}.bell{width:40px;height:40px;border-radius:14px;display:grid;place-items:center;background:linear-gradient(135deg,var(--yellow),var(--yellow2));box-shadow:0 12px 22px rgba(21,153,71,.18)}.alert-item span,.muted,.empty-note{color:#b8c0cb}.mini-btn{padding:9px 13px;border-radius:12px}.admin-hero{border-radius:0 0 24px 24px;margin-bottom:20px}.side .brand img{background:linear-gradient(145deg,#f7f7f7,#d8d8d8);mix-blend-mode:normal}.side .brand{background:radial-gradient(circle at 50% 28%,rgba(21,153,71,.10),transparent 44%)}
...
.menu-item.active,.menu-item.parent-active{background:linear-gradient(90deg,rgba(21,153,71,.16),rgba(21,153,71,.035) 42%,transparent)!important;border-left-color:var(--yellow)!important;color:#fff!important;box-shadow:inset 4px 0 0 var(--yellow);}
.menu-item.sub-mini.active{background:rgba(21,153,71,.12)!important;color:#fff!important;border-left-color:var(--yellow)!important;box-shadow:inset 4px 0 0 var(--yellow);}
.menu-group.force-open>.menu-title{background:linear-gradient(135deg,var(--yellow2),var(--yellow));color:#181a1f;}
.nested.force-open>.menu-item.parent-active{background:linear-gradient(90deg,rgba(21,153,71,.14),rgba(21,153,71,.04),transparent)!important;color:#fff!important;}
.nested>.menu-item:focus,.nested>.menu-item:active{background:linear-gradient(90deg,rgba(21,153,71,.16),rgba(21,153,71,.035),transparent)!important;color:#fff!important;outline:none!important;}
...
.gestion-card:after{content:"";position:absolute;inset:auto -35px -35px auto;width:120px;height:120px;border-radius:999px;background:rgba(21,153,71,.10)}
...
:root{
  ...
  --accent:#00a884!important;
  --accent2:#159947!important;
  --bg:#eef4f8!important;
...
.side{width:350px!important;background:linear-gradient(180deg,#07111d 0%,#0b1522 58%,#070d16 100%)!important;border-right:1px solid rgba(21,153,71,.35)!important;scrollbar-width:thin;scrollbar-color:#159947 #07111d}
.side::-webkit-scrollbar{width:10px}.side::-webkit-scrollbar-thumb{background:#159947;border-radius:999px}.side::-webkit-scrollbar-track{background:#07111d}
.side-top{background:#06111d!important;border-bottom:1px solid rgba(21,153,71,.35)!important}
...
.menu-item:hover{background:rgba(21,153,71,.12)!important}.menu-item.active,.menu-title.active{background:linear-gradient(135deg,#159947,#00a884)!important;color:#07111d!important}.menu-item.active *,.menu-title.active *{color:#07111d!important}
...
/* ===== PORTAL HR PRO - TEMA VERDE, SOLO CONTRATACIÓN ===== */
:root{--green:#159947!important;--green2:#00a884!important;--txt:#101827!important;--mut:#6b7280!important;--yellow:#159947!important;--yellow2:#00a884!important;}
body{background:#f4f8fb!important;color:#111827!important;font-family:Inter,Segoe UI,Arial,sans-serif!important;}
.btn-green,.btn-blue,.crear-btn,.c-btn.primary,button.btn-green{background:linear-gradient(135deg,#16a34a,#008c72)!important;color:#fff!important;border:0!important;border-radius:14px!important;box-shadow:0 12px 25px rgba(0,137,87,.20)!important;}
.btn,.btn-blue{border-color:#d8e3ea!important;color:#159947!important;background:#fff!important;}
.flash{background:#dff7ea!important;border-color:#98e5ba!important;color:#064e3b!important}.flash.err{background:#fee2e2!important;color:#991b1b!important;border-color:#fecaca!important}
.input,select,textarea{background:#fff!important;color:#111827!important;border:1px solid #dbe5ed!important;border-radius:14px!important}.input:focus,select:focus,textarea:focus{border-color:#22c55e!important;box-shadow:0 0 0 4px rgba(34,197,94,.12)!important}
.side{width:302px!important;background:linear-gradient(180deg,#0b3b26 0%,#0f3f2d 42%,#0f172a 100%)!important;border-right:1px solid rgba(255,255,255,.08)!important;box-shadow:12px 0 35px rgba(15,23,42,.18)!important;}
.side-top{background:transparent!important;border-bottom:1px solid rgba(255,255,255,.08)!important;height:92px!important;padding:24px 22px!important}.side-top .label{font-size:20px!important;font-weight:1000!important;color:#fff!important}.brand{padding:0 22px 18px!important;text-align:left!important}.brand img{display:none!important}.brand-title{font-size:22px;font-weight:1000;color:#fff;line-height:1.05}.brand p{margin:4px 0 0!important;color:#d1fae5!important;font-size:12px!important;font-weight:900!important}.toggle{background:rgba(255,255,255,.12)!important;border-radius:16px!important;width:44px!important;height:44px!important;display:grid!important;place-items:center!important;color:#fff!important}
.menu-title,.menu-item{background:transparent!important;border:0!important;color:#cbd5e1!important;border-radius:16px!important;margin:7px 16px!important;padding:14px 16px!important;font-size:15px!important;font-weight:950!important}.menu-title.active,.menu-item.active,.menu-item:hover,.menu-title:hover{background:#16a34a!important;color:#fff!important;box-shadow:none!important}.menu-title.active *,.menu-item.active *,.menu-item:hover *,.menu-title:hover *{color:#fff!important}.sub-mini{padding-left:34px!important;font-size:14px!important}.side-user{position:fixed!important;left:15px!important;bottom:8px!important;width:272px!important;background:rgba(255,255,255,.10)!important;border-radius:20px!important;color:#d1fae5!important;padding:12px!important}
.main{background:radial-gradient(circle at 95% 0%,rgba(34,197,94,.12),transparent 25%),#f4f8fb!important;padding:25px 32px 50px!important}.hero{background:#fff!important;border:1px solid #e2e8f0!important;border-radius:24px!important;margin:0 0 20px!important;padding:22px 24px!important;box-shadow:0 14px 35px rgba(15,23,42,.06)!important}.topbar h1{color:#0f172a!important}.subtitle{color:#6b7280!important}.card,.doc-card,.avatar-panel,.profile-main,.profile-col{background:#fff!important;color:#111827!important;border:1px solid #e2e8f0!important;border-radius:22px!important;box-shadow:0 14px 35px rgba(15,23,42,.06)!important}.mini b,.topbar h1 .accent,th,.ficha-tabs .tab.active,.mini-chip{color:#159947!important}.ico{background:#dcfce7!important;color:#159947!important;box-shadow:none!important}table{background:#fff!important;color:#111827!important}th{background:#f8fafc!important}td{border-bottom:1px solid #edf2f7!important;color:#111827!important}tr:hover td{background:#f8fafc!important}
.login-body{background:radial-gradient(circle at 3% 0%,rgba(34,197,94,.18) 0 23%,transparent 23.3%),radial-gradient(circle at 94% -2%,rgba(45,212,191,.16) 0 18%,transparent 18.3%),linear-gradient(180deg,#f9fbfb 0%,#eefaf5 100%)!important;min-height:100vh!important;display:grid!important;place-items:center!important;overflow:hidden!important}.login-body:after{content:"";position:fixed;left:-5%;right:-5%;bottom:-80px;height:230px;background:linear-gradient(135deg,#2ac878,#007f68);border-radius:50% 50% 0 0;transform:rotate(-3deg);z-index:0}.login-body:before{content:"";position:fixed;left:18%;top:48%;width:86px;height:86px;border-radius:50%;background:#28c978;box-shadow:920px 0 0 #28c978;z-index:0}.login-card{width:min(92vw,528px)!important;background:#fff!important;border:1px solid #e5eef3!important;border-radius:32px!important;padding:78px 56px 30px!important;box-shadow:0 35px 95px rgba(15,23,42,.10)!important;position:relative!important;overflow:visible!important;z-index:1}.login-card:before{content:"👥"!important;position:absolute!important;left:50%!important;top:-64px!important;transform:translateX(-50%)!important;width:126px!important;height:126px!important;border-radius:50%!important;background:#fff!important;border:1px solid #e5eef3!important;display:grid!important;place-items:center!important;font-size:54px!important;color:#159947!important;box-shadow:0 18px 55px rgba(15,23,42,.08)!important}.login-card:after{display:none!important}.login-logo{display:none!important}.login-title h1{font-size:38px!important;color:#172033!important;margin-bottom:10px!important}.login-title b{color:#718096!important}.login-title:after{content:"";display:block;width:58px;height:4px;border-radius:999px;background:#10b981;margin:20px auto 0}.login-card .field label{display:block!important;color:#333!important;font-weight:950!important;margin:0 0 8px!important}.login-input{background:#eaf2ff!important;border:1px solid #d6e3f5!important;border-radius:14px!important;padding:0 14px!important;margin-bottom:22px!important;color:#159947!important}.login-input:focus-within{border-color:#22c55e!important;box-shadow:0 0 0 3px rgba(34,197,94,.15)!important}.login-input input,.login-input select{color:#111827!important;background:transparent!important}.login-card .btn-green{width:100%!important;justify-content:center!important;font-size:20px!important;margin:8px 0 28px!important;padding:17px!important;border-radius:14px!important;background:linear-gradient(135deg,#16a34a,#008c72)!important}.login-links{margin-top:0!important;color:#718096!important}.mobile-head{background:#0b3b26!important;color:#fff!important}
...
def render_page(content, title="PORTAL HR PRO", active="Inicio"):
    user_label = session.get('admin_nombre') or session.get('nombre') or 'Usuario'
    ...
    <div class="app"><aside class="side"><div class="side-top"><button class="toggle" title="Expandir / contraer panel" onclick="toggleSide()">☰</button><b class="label">PORTAL HR PRO</b><button class="toggle" title="Expandir / contraer panel" onclick="toggleSide()">☰</button></div>
      <div class="brand"><div class="brand-title">PORTAL HR PRO</div><p>Gestión de Contratación</p></div>{sidebar(active)}<div class="side-user"><div class="avatar">👤</div><div><b>{primer_nombre}</b><br><small>{'Administrador' if session.get('admin_id') else 'Trabajador'}</small></div></div></aside><main class="main">{flashes()}{content}</main></div>'''
...
def sidebar(active):
    ...
    def cls(sec=''):
        return 'menu-item active' if active_sub == sec or (sec == '' and active_txt == 'Gestion Contratacion') else 'menu-item'
          ...
          <div id='grp_contratacion' data-group='contratacion' class='menu-group force-open'>
            ...
            <div class='submenu'>
              ...
              <div id='grp_con_maestros' data-group='con_maestros' class='menu-group nested force-open'>
                <button type='button' class='menu-title' onclick="toggleGroup('grp_con_maestros')"><span>💼</span><span class='label'>Datos Maestros</span><span class='chev'>∨</span></button>
                <div class='submenu'>
                  ...
                  <a class='menu-item sub-mini {'active' if active_sub == 'observados' else ''}' onclick='saveSideScroll()' href='/admin/contratacion?sec=observados'><span>•</span><span class='label'>Trabajadores Observados</span></a>
              ...
              <a class='menu-item {'active' if active_sub == 'anuncios' else ''}' onclick='saveSideScroll()' href='/admin/contratacion?sec=anuncios'><span>📢</span><span class='label'>Anuncios</span></a>
              <a class='menu-item' href='/logout'><span>🚪</span><span class='label'>Salir</span></a>
            </div>
          </div>
        </nav>"""
    return """
      <nav>
        <div id='grp_user_contrato' data-group='user_contrato' class='menu-group force-open'>
          <button type='button' class='menu-title active' onclick="toggleGroup('grp_user_contrato')"><span>🧾</span><span class='label'>Gestión Contrato</span><span class='chev'>∨</span></button>
          <div class='submenu'>
            <a class='menu-item active' onclick='saveSideScroll()' href='/contratacion/mis_documentos'><span>📊</span><span class='label'>Dashboard contrato</span></a>
            <a class='menu-item' onclick='saveSideScroll()' href='/contratacion/mis_documentos#mis-contratos'><span>📄</span><span class='label'>Mis contratos</span></a>
            <a class='menu-item' href='/logout'><span>🚪</span><span class='label'>Salir</span></a>
          </div>
        </div>
      </nav>"""
...
@admin_required
def admin():
    return redirect('/admin/contratacion?sec=flujo')
    sincronizar_documentos_carpeta()
    ...
    <div class='admin-shell'>
      ...
      <div class='admin-footer'><span>© 2026 PORTAL HR PRO - Superfruits</span><span>Versión 1.0.0</span></div>
    </div>
    """
...
def admin_contratacion():
    ...
    .main{background:radial-gradient(circle at 95% -8%,rgba(21,153,71,.12),transparent 24%),linear-gradient(180deg,#0f141a,#111821)!important;color:#f8fafc!important}.c-title,h1,h2,h3{color:#f8fafc!important}.c-card,.filter-card,.table-wrap{background:linear-gradient(145deg,#171f28,#111821)!important;border:1px solid #34404d!important;color:#f8fafc!important}.c-filter input,.c-filter select,.c-form input,.c-form select,input,select,textarea{background:#0b1119!important;color:#f8fafc!important;border:1.5px solid #34404d!important}.c-table,table{background:#111821!important;color:#f8fafc!important}.c-table th,th{background:#0b1119!important;color:#159947!important;border-color:#364250!important}.c-table td,td{background:#151d26!important;color:#eaf2fb!important;border-color:#2b3541!important}.c-table tr:nth-child(even) td{background:#111821!important}.plantilla-table td,.plantilla-table td *{color:#eaf2fb!important;opacity:1!important}.plantilla-table th{color:#159947!important}.plantilla-top .crear-btn{position:relative!important;right:auto!important;top:auto!important;min-width:190px!important}.plantilla-top{gap:16px!important}.icon-btn{color:#159947!important}.tpl-link{color:#fff!important}.state-select{background:#0b1119!important;color:#159947!important;border:1px solid #159947!important}.ficha-search{display:flex;gap:12px;margin:0 0 16px;max-width:720px}.ficha-search input{flex:1}.ficha-profile{display:grid;grid-template-columns:150px minmax(320px,1.4fr) minmax(260px,1fr) minmax(260px,1fr);gap:18px;align-items:stretch;margin-bottom:18px}.avatar-panel,.profile-main,.profile-col{background:linear-gradient(145deg,#171f28,#111821);border:1px solid #34404d;border-radius:18px;padding:18px;color:#f8fafc;box-shadow:0 16px 34px rgba(0,0,0,.22)}.avatar-panel{display:grid;place-items:center}.profile-main h2{margin:0 0 10px;color:#fff;font-size:22px}.profile-main p,.profile-col p{margin:8px 0;color:#eaf2fb}.created-box{background:#0b1119;border:1px solid #34404d;border-radius:12px;padding:10px;margin-top:12px;color:#cbd5e1}.status-dot,.status-pill{display:inline-flex;align-items:center;gap:6px;padding:7px 12px;border-radius:999px;font-weight:1000}.status-dot.ok,.status-pill.ok{background:rgba(34,197,94,.13);color:#86efac;border:1px solid rgba(34,197,94,.45)}.status-dot.bad,.status-pill.bad{background:rgba(244,63,94,.13);color:#fecdd3;border:1px solid rgba(244,63,94,.45)}.ficha-tabs{display:flex!important;padding:0!important;margin:0 0 16px!important;overflow:hidden}.ficha-tabs .tab{flex:1;background:transparent;border:0;border-bottom:3px solid transparent;color:#cbd5e1!important;cursor:pointer;font-size:16px}.ficha-tabs .tab.active{color:#159947!important;border-bottom-color:#159947!important}.ficha-tab-content{display:none}.ficha-tab-content.active{display:block}.laboral-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px 28px;padding:24px!important}.laboral-grid label{display:grid;grid-template-columns:220px 1fr;align-items:center;gap:12px;color:#f8fafc!important}.periodos-box{margin-top:14px;background:#111821;border:1px solid #34404d;border-radius:14px;padding:14px;color:#eaf2fb}.mini-chip{display:inline-flex;margin:5px;padding:8px 12px;border-radius:999px;background:rgba(21,153,71,.12);color:#159947;border:1px solid rgba(21,153,71,.35);font-weight:900}.period-row td{background:#0b1119!important;color:#159947!important;font-size:16px}.check-green{display:inline-grid;place-items:center;min-width:54px;padding:7px 13px;background:#4ea60f;color:white;border-radius:8px;font-weight:1000}.check-gray{display:inline-grid;place-items:center;min-width:54px;padding:7px 13px;background:#334155;color:#cbd5e1;border-radius:8px;font-weight:1000}@media(max-width:1100px){.ficha-profile{grid-template-columns:1fr}.laboral-grid{grid-template-columns:1fr}.laboral-grid label{grid-template-columns:1fr}.plantilla-filter{grid-template-columns:1fr!important}}
...
def api_health(): return jsonify({'ok': True, 'mensaje': 'Portal PORTAL HR PRO activo - optimizado Render Free'})
...
if __name__ == '__main__':
    ...
    try:
        print('============================================================')
        print('Portal PORTAL HR PRO iniciado')
