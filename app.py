...
/* === FIX FINAL 2026-05-28: compactar panel y formularios === */
.app{grid-template-columns:280px minmax(0,1fr)!important;background:#f6fbfa!important;}
.app.side-collapsed{grid-template-columns:74px minmax(0,1fr)!important;}
.side{width:280px!important;background:#053d31!important;border-right:1px solid rgba(255,255,255,.12)!important;box-shadow:8px 0 22px rgba(15,23,42,.16)!important;}
.side.collapsed{width:74px!important;}
.main{padding:16px 18px 32px!important;background:linear-gradient(135deg,#f8fbfd 0%,#eef7f4 100%)!important;overflow-x:hidden!important;}
.menu-group{margin:7px 10px!important;border-radius:16px!important;}
.menu-title,.menu-item{min-height:46px!important;padding:10px 12px!important;border-radius:14px!important;font-size:14px!important;line-height:1.15!important;gap:10px!important;}
.menu-item{padding-left:32px!important;margin:3px 0!important;}
.menu-title .ico,.menu-item .ico,.menu-title i,.menu-item i{width:38px!important;height:38px!important;min-width:38px!important;border-radius:12px!important;font-size:18px!important;display:inline-grid!important;place-items:center!important;background:rgba(255,255,255,.13)!important;color:#eafff6!important;}
.submenu{padding:6px 0!important;}
.side .label{white-space:normal!important;overflow:visible!important;text-overflow:clip!important;}

.c-title{font-size:22px!important;margin:0 0 14px!important;}
.dash-hero{padding:22px 28px!important;border-radius:22px!important;margin-bottom:16px!important;min-height:auto!important;}
.dash-hero h1{font-size:34px!important;line-height:1.05!important;margin:0 0 10px!important;}
.dash-hero p,.muted2{font-size:15px!important;line-height:1.45!important;}
.pro-card,.c-card,.filter-card,.table-wrap,.nice-form{border-radius:18px!important;padding:18px!important;box-shadow:0 12px 30px rgba(15,23,42,.07)!important;}
.pro-section-title{grid-column:1/-1!important;margin:0 0 10px!important;padding:12px 14px!important;border-radius:14px!important;font-size:17px!important;line-height:1.2!important;background:#ecfdf5!important;border:1px solid #a7f3d0!important;color:#063f32!important;}
.nice-form,.compact-form,.pro-form,.c-form{gap:12px 16px!important;}
.nice-form b,.pro-form b,.c-form b,.compact-form b{min-height:42px!important;padding:10px 12px!important;border-radius:12px!important;font-size:14px!important;line-height:1.15!important;background:#edf3f8!important;color:#08243f!important;text-align:right!important;display:flex!important;align-items:center!important;justify-content:flex-end!important;white-space:normal!important;}
.nice-form input,.nice-form select,.nice-form textarea,.pro-form input,.pro-form select,.pro-form textarea,.c-form input,.c-form select,.c-form textarea,input,select,textarea{min-height:42px!important;height:auto!important;padding:10px 12px!important;border-radius:12px!important;font-size:14px!important;line-height:1.2!important;color:#0b2239!important;background:#fff!important;min-width:0!important;max-width:100%!important;}
textarea{min-height:70px!important;}
.c-btn,.btn-green,.btn-blue,.crear-btn,.btn,.btn-del{min-height:42px!important;padding:10px 16px!important;border-radius:14px!important;font-size:14px!important;line-height:1.15!important;white-space:normal!important;}

.req-pro-grid{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr)!important;gap:16px!important;align-items:start!important;overflow:visible!important;}
.req-pro-grid>.pro-card{min-width:0!important;overflow:visible!important;padding:18px!important;}
.req-pro-grid .nice-form{grid-template-columns:170px minmax(0,1fr)!important;gap:12px 14px!important;}
.req-pro-grid .nice-form b{justify-content:flex-end!important;text-align:right!important;}
.req-pro-grid .nice-form .actions,.req-pro-grid .nice-form button,.req-pro-grid .nice-form .c-btn{grid-column:auto!important;width:auto!important;}
.req-pro-grid .camera-scan-box,.req-pro-grid .scanner-box,.req-pro-grid .scan-camera,.req-pro-grid .camera-box{grid-column:1/-1!important;width:100%!important;min-height:210px!important;margin-top:6px!important;}
.req-pro-grid video,.req-pro-grid canvas{width:100%!important;max-width:100%!important;min-height:210px!important;border-radius:16px!important;background:#e9eef4!important;display:block!important;}
.req-pro-grid .actions{grid-column:1/-1!important;display:flex!important;gap:10px!important;flex-wrap:wrap!important;align-items:center!important;}

.ingreso-form,.worker-form{grid-template-columns:170px minmax(0,1fr) 170px minmax(0,1fr)!important;gap:12px 16px!important;align-items:center!important;}
.media-grid{grid-column:1/-1!important;display:grid!important;grid-template-columns:minmax(420px,1.1fr) minmax(320px,.9fr)!important;gap:18px!important;align-items:start!important;margin-top:8px!important;}
.media-card{position:relative!important;min-width:0!important;padding:18px!important;border-radius:18px!important;background:#fff!important;border:1px solid #dbe5ee!important;}
.media-title{position:static!important;margin-bottom:12px!important;width:auto!important;display:inline-flex!important;background:#edf3f8!important;color:#08243f!important;border-radius:12px!important;padding:10px 14px!important;font-weight:900!important;}
.camera-box{padding:14px!important;border-radius:18px!important;display:grid!important;grid-template-columns:minmax(240px,360px) minmax(180px,1fr)!important;gap:16px!important;align-items:start!important;}
.camera-box video,.camera-box img{width:100%!important;max-width:360px!important;min-height:250px!important;object-fit:cover!important;border-radius:18px!important;background:#111827!important;}
.cam-actions{display:flex!important;flex-direction:column!important;gap:10px!important;align-items:flex-start!important;}
.bio-box{display:grid!important;gap:12px!important;align-items:start!important;}
.bio-actions{display:flex!important;gap:10px!important;flex-wrap:wrap!important;}

.learning-grid{display:grid!important;grid-template-columns:minmax(0,1.8fr) minmax(320px,.9fr)!important;gap:18px!important;align-items:start!important;}
.learning-grid .nice-form{grid-template-columns:170px minmax(0,1fr) 170px minmax(0,1fr)!important;gap:12px 16px!important;}
.learning-grid .eval-side{position:static!important;overflow:hidden!important;}
.learning-grid .eval-grid{display:grid!important;grid-template-columns:160px minmax(0,1fr)!important;gap:12px!important;}
.learning-grid input[type=file]{font-size:13px!important;white-space:normal!important;}
.records-toolbar{display:grid!important;grid-template-columns:minmax(220px,1fr) 220px auto auto!important;gap:10px!important;align-items:center!important;margin:12px 0!important;}
.clean-table th,.clean-table td,.c-table th,.c-table td{font-size:13px!important;padding:11px 12px!important;vertical-align:middle!important;}
.table-wrap{max-width:100%!important;overflow-x:auto!important;}

@media(max-width:1200px){
  .req-pro-grid,.learning-grid,.media-grid{grid-template-columns:1fr!important;}
  .nice-form,.compact-form,.pro-form,.c-form,.ingreso-form,.worker-form,.learning-grid .nice-form{grid-template-columns:150px minmax(0,1fr)!important;}
}
@media(max-width:760px){
  .app,.app.side-collapsed{grid-template-columns:1fr!important;}
  .main{padding:12px!important;}
  .nice-form,.compact-form,.pro-form,.c-form,.req-pro-grid .nice-form,.ingreso-form,.worker-form,.learning-grid .nice-form,.learning-grid .eval-grid{grid-template-columns:1fr!important;}
  .nice-form b,.pro-form b,.c-form b,.compact-form b{justify-content:flex-start!important;text-align:left!important;}
  .camera-box{grid-template-columns:1fr!important;}
...
<style id="fix-layout-final-urgente">
/* ===== FIX URGENTE: formularios legibles, cámara visible y módulos sin recortes ===== */
.main,.content,.app-main{max-width:100%!important;overflow-x:hidden!important;padding:24px 28px!important;box-sizing:border-box!important;}
.c-card,.pro-card,.dash-card,.table-wrap{overflow:visible!important;box-sizing:border-box!important;}
.req-pro-grid{display:grid!important;grid-template-columns:1fr!important;gap:22px!important;width:100%!important;max-width:100%!important;}
.req-pro-grid .pro-card{width:100%!important;max-width:100%!important;}
.nice-form,.pro-form,.compact-form,.c-form{display:grid!important;grid-template-columns:220px minmax(260px,1fr) 220px minmax(260px,1fr)!important;gap:16px 20px!important;align-items:center!important;padding:30px!important;}
.nice-form b,.pro-form b,.compact-form b,.c-form b{white-space:normal!important;line-height:1.18!important;min-height:50px!important;justify-content:flex-end!important;text-align:right!important;color:#08243f!important;background:#eef4f8!important;}
.nice-form input,.nice-form select,.nice-form textarea,.pro-form input,.pro-form select,.pro-form textarea,.compact-form input,.compact-form select,.compact-form textarea,.c-form input,.c-form select,.c-form textarea{min-width:0!important;width:100%!important;font-size:16px!important;line-height:1.3!important;color:#102033!important;}
.pro-section-title,.section-head{grid-column:1/-1!important;margin:2px 0 18px!important;}
.actions{grid-column:2/-1!important;display:flex!important;align-items:center!important;gap:14px!important;flex-wrap:wrap!important;}
/* Requerimientos: cámara de escaneo visible, sin quedar escondida al costado */
.scan-box{grid-column:1/-1!important;display:grid!important;grid-template-columns:minmax(380px,1.2fr) minmax(300px,.8fr)!important;gap:18px!important;align-items:stretch!important;overflow:visible!important;}
.scan-camera{min-height:340px!important;width:100%!important;border-radius:22px!important;background:#eef3f8!important;display:grid!important;place-items:center!important;text-align:center!important;padding:24px!important;}
.scan-camera video{display:block!important;width:100%!important;min-height:320px!important;max-height:420px!important;border-radius:18px!important;background:#111!important;object-fit:cover!important;}
.scan-tools{display:grid!important;grid-template-columns:1fr 1fr!important;gap:12px!important;align-content:start!important;}
.scan-counter{grid-column:1/-1!important;display:flex!important;gap:10px!important;flex-wrap:wrap!important;align-items:center!important;}
.mini-list{grid-column:1/-1!important;display:grid!important;gap:8px!important;max-height:180px!important;overflow:auto!important;}
.mini-list div{display:grid!important;grid-template-columns:110px 1fr auto!important;gap:10px!important;background:#f8fafc!important;border:1px solid #dbe7f1!important;border-radius:12px!important;padding:10px 12px!important;}
/* Ficha trabajador: cámara y biometría separados, sin taparse */
.media-capture-grid{grid-column:1/-1!important;display:grid!important;grid-template-columns:minmax(420px,1fr) minmax(360px,.85fr)!important;gap:24px!important;align-items:start!important;margin-top:8px!important;}
.media-card{background:#f8fbfd!important;border:1px dashed #c9d8e8!important;border-radius:20px!important;padding:20px!important;box-sizing:border-box!important;}
.media-title{display:inline-flex!important;align-items:center!important;justify-content:center!important;background:#eef4f8!important;color:#08243f!important;border-radius:14px!important;font-weight:1000!important;padding:12px 16px!important;margin-bottom:14px!important;min-width:170px!important;}
.camera-box{display:grid!important;grid-template-columns:minmax(260px,420px) minmax(180px,240px)!important;gap:18px!important;align-items:start!important;border:0!important;background:transparent!important;padding:0!important;}
.camera-box video,.camera-box img{display:block!important;width:100%!important;min-height:300px!important;max-height:360px!important;border-radius:18px!important;background:#111!important;object-fit:cover!important;}
.cam-actions{display:grid!important;gap:12px!important;margin:0!important;align-content:start!important;}
.camera-box small{grid-column:1/-1!important;color:#64748b!important;font-weight:700!important;line-height:1.35!important;}
.bio-box{display:grid!important;gap:14px!important;background:transparent!important;padding:0!important;}
.bio-box input[type=file]{min-height:52px!important;background:#fff!important;}
.bio-actions{display:flex!important;gap:12px!important;flex-wrap:wrap!important;align-items:center!important;}
.bio-box small{display:block!important;color:#64748b!important;font-weight:700!important;line-height:1.35!important;}
/* Inducción/cursos: no recortar campos ni botones */
.learning-grid{display:grid!important;grid-template-columns:1fr!important;gap:22px!important;align-items:start!important;}
.learning-grid.con-evaluacion{grid-template-columns:minmax(0,1.25fr) minmax(380px,.75fr)!important;}
.learning-grid.solo-induccion{grid-template-columns:1fr!important;}
.learning-grid .nice-form{grid-template-columns:220px minmax(260px,1fr) 220px minmax(260px,1fr)!important;}
.eval-side{padding:28px!important;overflow:visible!important;}
.eval-grid{display:grid!important;grid-template-columns:190px minmax(220px,1fr)!important;gap:14px!important;align-items:center!important;}
.records-toolbar{display:grid!important;grid-template-columns:minmax(280px,1fr) 220px auto auto!important;gap:12px!important;align-items:center!important;margin:14px 0!important;}
.records-toolbar input,.records-toolbar select{min-height:48px!important;border:1px solid #cfe0ef!important;border-radius:14px!important;padding:10px 14px!important;background:#fff!important;color:#102033!important;font-weight:700!important;}
/* Panel lateral iconos estilo limpio */
.side .menu-item span:first-child,.side .menu-title span:first-child{background:rgba(255,255,255,.12)!important;border-radius:12px!important;min-width:36px!important;width:36px!important;height:36px!important;display:grid!important;place-items:center!important;font-size:18px!important;}
.side .menu-item,.side .menu-title{gap:12px!important;font-weight:900!important;letter-spacing:.01em!important;}
/* Tablas y botones suaves */
.c-table th,.c-table td{font-size:14px!important;line-height:1.3!important;}
.status-pill{color:#065f46!important;background:#dcfce7!important;border-color:#86efac!important;}
.c-btn{white-space:normal!important;text-align:center!important;line-height:1.15!important;}
@media(max-width:1200px){
 .nice-form,.pro-form,.compact-form,.c-form,.learning-grid .nice-form{grid-template-columns:180px minmax(0,1fr)!important;}
 .actions{grid-column:1/-1!important;}
 .media-capture-grid,.scan-box,.learning-grid.con-evaluacion{grid-template-columns:1fr!important;}
 .camera-box{grid-template-columns:1fr!important;}
 .scan-tools{grid-template-columns:1fr 1fr!important;}
}
@media(max-width:760px){
 .main,.content,.app-main{padding:16px!important;}
 .nice-form,.pro-form,.compact-form,.c-form,.learning-grid .nice-form,.eval-grid{grid-template-columns:1fr!important;padding:18px!important;}
 .nice-form b,.pro-form b,.compact-form b,.c-form b{justify-content:flex-start!important;text-align:left!important;}
 .records-toolbar,.scan-tools{grid-template-columns:1fr!important;}
...
<style id="fix-compacto-visual-final-20260528">
/* =========================================================
   FIX COMPACTO FINAL: sidebar sin hueco, formularios compactos,
   cards/recuadros bajos y dashboard ancho completo.
   Solo cambia presentación, no lógica.
   ========================================================= */
:root{--side-w-final:260px;--side-w-collapsed-final:78px;}
html,body{width:100%!important;max-width:100%!important;overflow-x:hidden!important;}
body{background:#f4faf8!important;}
.app{grid-template-columns:var(--side-w-final) minmax(0,1fr)!important;background:#f4faf8!important;width:100%!important;max-width:100%!important;}
.app.side-collapsed{grid-template-columns:var(--side-w-collapsed-final) minmax(0,1fr)!important;}
.side{width:var(--side-w-final)!important;min-width:var(--side-w-final)!important;max-width:var(--side-w-final)!important;height:100vh!important;padding:8px 0 10px!important;margin:0!important;background:#063d31!important;border-right:1px solid rgba(255,255,255,.08)!important;box-shadow:6px 0 16px rgba(15,23,42,.12)!important;box-sizing:border-box!important;overflow-x:hidden!important;}
.side.collapsed{width:var(--side-w-collapsed-final)!important;min-width:var(--side-w-collapsed-final)!important;max-width:var(--side-w-collapsed-final)!important;}
.side-head-pro{height:54px!important;min-height:54px!important;margin:0 8px 10px!important;padding:0 8px!important;border-radius:14px!important;display:flex!important;align-items:center!important;gap:8px!important;}
.side-brand-pro{gap:8px!important;min-width:0!important;flex:1 1 auto!important;overflow:hidden!important;}
.side-brand-icon{width:36px!important;height:36px!important;min-width:36px!important;border-radius:12px!important;font-size:18px!important;}
.side-brand-text b{font-size:13.5px!important;line-height:1.05!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;}
.side-brand-text small{display:none!important;}
.side-head-pro .toggle{width:36px!important;height:36px!important;min-width:36px!important;border-radius:12px!important;font-size:20px!important;}
.side-toggle-right{display:none!important;}
.side nav, nav{padding:0 6px 8px!important;margin:0!important;box-sizing:border-box!important;}
.menu-group{margin:3px 0!important;border-radius:12px!important;overflow:visible!important;}
.menu-group.nested{margin-left:4px!important;padding-left:4px!important;}
.submenu{padding:3px 0!important;max-height:none!important;overflow:visible!important;}
.menu-title,.side .menu-title,.menu-item,.side .menu-item{min-height:46px!important;margin:3px 2px!important;padding:8px 9px!important;border-radius:14px!important;gap:8px!important;font-size:13px!important;line-height:1.12!important;font-weight:820!important;letter-spacing:0!important;box-sizing:border-box!important;width:auto!important;max-width:100%!important;}
.menu-title .label,.menu-item .label{display:block!important;min-width:0!important;max-width:150px!important;white-space:normal!important;line-height:1.12!important;overflow:visible!important;color:inherit!important;}
.menu-title i,.menu-item i,.side .menu-item span:first-child,.side .menu-title span:first-child{width:34px!important;height:34px!important;min-width:34px!important;border-radius:12px!important;font-size:16px!important;display:grid!important;place-items:center!important;flex:0 0 34px!important;}
.menu-title .chev{margin-left:auto!important;font-size:12px!important;flex:0 0 auto!important;}
.menu-item.sub-mini{min-height:38px!important;margin-left:12px!important;font-size:12.5px!important;padding:8px 9px!important;}
.side-user{display:none!important;}
.side.collapsed nav{padding:0 6px!important;}
.side.collapsed .menu-title,.side.collapsed .menu-item{justify-content:center!important;padding:8px 4px!important;margin:4px 0!important;}
.side.collapsed .label,.side.collapsed .chev,.side.collapsed .side-brand-text{display:none!important;}
.side.collapsed .side-head-pro{height:52px!important;min-height:52px!important;margin:0 6px 10px!important;justify-content:center!important;}
.side.collapsed .side-brand-icon{display:none!important;}
.side.collapsed .side-head-pro .toggle{width:38px!important;height:38px!important;}
.main,.content,.app-main{width:100%!important;max-width:100%!important;min-width:0!important;margin:0!important;padding:12px 16px 24px!important;box-sizing:border-box!important;background:#f4faf8!important;overflow-x:hidden!important;}
.hero,.dash-hero{margin:0 0 12px!important;padding:16px 18px!important;border-radius:18px!important;width:100%!important;box-sizing:border-box!important;}
.topbar h1,.dash-hero h1,h1,.c-title{font-size:clamp(22px,2vw,30px)!important;line-height:1.05!important;margin:0 0 6px!important;}
h2{font-size:22px!important;line-height:1.12!important;}.subtitle,.muted,.muted2{font-size:13px!important;line-height:1.35!important;margin:0!important;}
.grid{gap:10px!important;width:100%!important;}.card,.c-card,.pro-card,.dash-card,.doc-card,.module-card,.worker-eval,.eval-side{border-radius:16px!important;padding:14px!important;margin-bottom:12px!important;min-height:0!important;box-shadow:0 8px 20px rgba(15,23,42,.055)!important;box-sizing:border-box!important;overflow:visible!important;}
.doc-grid{grid-template-columns:repeat(auto-fit,minmax(180px,1fr))!important;gap:10px!important;width:100%!important;}.doc-card{min-height:96px!important;padding:13px!important;}.doc-card h3{font-size:15px!important;margin:0 0 6px!important;}.doc-card p{font-size:12.5px!important;line-height:1.32!important;margin:0 0 8px!important;}
.mini{min-height:92px!important;padding:13px!important;}.mini b{font-size:22px!important;}.ico{width:42px!important;height:42px!important;border-radius:13px!important;font-size:18px!important;}
.req-pro-grid,.photo-id-layout,.split-two,.admin-course-grid,.learning-grid,.learning-grid.con-evaluacion{display:grid!important;grid-template-columns:1fr!important;gap:12px!important;width:100%!important;max-width:100%!important;margin:10px 0!important;}
.nice-form,.pro-form,.compact-form,.c-form,.learning-grid .nice-form{display:grid!important;grid-template-columns:165px minmax(0,1fr)!important;gap:10px 14px!important;align-items:center!important;padding:14px!important;width:100%!important;box-sizing:border-box!important;}
.nice-form h3,.pro-section-title,.section-head{grid-column:1/-1!important;margin:0 0 6px!important;padding:9px 12px!important;border-radius:12px!important;font-size:15px!important;line-height:1.15!important;}
.nice-form b,.pro-form b,.compact-form b,.c-form b,.field-title,label{min-height:38px!important;padding:8px 10px!important;border-radius:12px!important;font-size:13px!important;line-height:1.1!important;font-weight:800!important;text-align:right!important;justify-content:flex-end!important;align-items:center!important;margin:0!important;box-sizing:border-box!important;}
.nice-form input,.nice-form select,.nice-form textarea,.pro-form input,.pro-form select,.pro-form textarea,.compact-form input,.compact-form select,.compact-form textarea,.c-form input,.c-form select,.c-form textarea,input,select,textarea{min-height:40px!important;height:auto!important;padding:8px 12px!important;border-radius:13px!important;font-size:14px!important;line-height:1.2!important;box-sizing:border-box!important;}
textarea,.nice-form textarea,.pro-form textarea,.compact-form textarea,.c-form textarea{min-height:66px!important;}
.actions,.modal-actions{gap:8px!important;margin-top:8px!important;}.c-btn,.btn,.btn-green,.btn-blue,button{min-height:38px!important;padding:7px 14px!important;border-radius:13px!important;font-size:13.5px!important;line-height:1.15!important;}
.table-wrap{width:100%!important;overflow:auto!important;border-radius:14px!important;margin:10px 0!important;}.clean-table,.c-table,table{width:100%!important;min-width:920px!important;font-size:13px!important;}.clean-table th,.c-table th,th{padding:9px 10px!important;font-size:12px!important;}.clean-table td,.c-table td,td{padding:8px 10px!important;font-size:12.5px!important;line-height:1.25!important;}
.c-filter,.module-tools,.records-toolbar{grid-template-columns:minmax(180px,1fr) auto auto!important;gap:8px!important;margin:10px 0!important;width:100%!important;}.c-filter input,.module-tools input,.module-tools select,.records-toolbar input,.records-toolbar select{min-height:40px!important;padding:8px 12px!important;font-size:13.5px!important;}
.scan-box,.media-capture-grid,.camera-box{grid-template-columns:1fr!important;gap:10px!important;padding:12px!important;}.scan-camera{min-height:190px!important;padding:14px!important;border-radius:16px!important;}.scan-camera video,.camera-box video,.camera-box img{min-height:190px!important;max-height:260px!important;border-radius:14px!important;}.scan-tools{grid-template-columns:1fr 1fr!important;gap:8px!important;}
.admin-header{position:sticky!important;top:0!important;z-index:100!important;background:#f4faf8!important;padding:8px 0!important;margin:0 0 8px!important;overflow:visible!important;}
.mobile-head{min-height:48px!important;padding:8px 12px!important;}
@media (max-width:1000px){
  .app,.app.side-collapsed{display:block!important;grid-template-columns:1fr!important;}
  .side{position:fixed!important;top:0!important;left:-260px!important;width:252px!important;min-width:252px!important;max-width:252px!important;height:100dvh!important;z-index:2147483644!important;padding-top:8px!important;transition:left .22s ease!important;}
  .side.open{left:0!important;}
  .side.collapsed{left:-260px!important;width:252px!important;min-width:252px!important;max-width:252px!important;}
  .main,.content,.app-main{margin-left:0!important;width:100%!important;padding:10px 10px 22px!important;}
  .side-head-pro{height:52px!important;min-height:52px!important;margin:0 7px 8px!important;}
  .side .menu-title,.side .menu-item{min-height:42px!important;padding:7px 8px!important;margin:3px 1px!important;font-size:12.8px!important;border-radius:12px!important;}
  .side .menu-title i,.side .menu-item i,.side .menu-item span:first-child,.side .menu-title span:first-child{width:32px!important;height:32px!important;min-width:32px!important;font-size:15px!important;}
  .menu-title .label,.menu-item .label{max-width:145px!important;}
  .hero,.dash-hero{padding:13px!important;border-radius:15px!important;}
  .card,.c-card,.pro-card,.dash-card,.doc-card,.module-card{padding:12px!important;border-radius:14px!important;}
  .doc-grid{grid-template-columns:1fr!important;gap:8px!important;}
  .nice-form,.pro-form,.compact-form,.c-form,.learning-grid .nice-form,.eval-grid{grid-template-columns:1fr!important;padding:12px!important;gap:8px!important;}
  .nice-form b,.pro-form b,.compact-form b,.c-form b,label{justify-content:flex-start!important;text-align:left!important;min-height:34px!important;}
  .c-filter,.module-tools,.records-toolbar,.scan-tools{grid-template-columns:1fr!important;}
  .topbar h1,.dash-hero h1,h1,.c-title{font-size:23px!important;white-space:normal!important;}
}
@media (min-width:1001px) and (max-width:1280px){
  :root{--side-w-final:248px;}
  .nice-form,.pro-form,.compact-form,.c-form{grid-template-columns:150px minmax(0,1fr)!important;}
}
</style>
...
def admin_contratacion():
    ...
    if request.method=='POST':
        ...
        if accion == 'registrar_dni_requerimiento':
            ...
            if not ticket or not dni:
                flash('Seleccione ticket y escanee/digite DNI obligatorio.', 'error')
            ...
            with db() as con:
                ...
                con.commit()
            flash('DNI conectado al ticket. Si existe, se marca como REINGRESANTE; si no, queda como NUEVO para completar ficha.', 'ok')
            return redirect(url_for('admin_contratacion', sec='requerimientos'))
        if accion == 'guardar_requerimiento':
            ...
            if not ticket or not sede or not area or not actividad or not fecha_ingreso:
                flash('Campos obligatorios: ticket, sede, área, actividad y fecha objetivo.', 'error')
                return redirect(url_for('admin_contratacion', sec='requerimientos'))
            ...
            with db() as con:
                ...
                con.commit()
            flash('Ticket de requerimiento registrado correctamente.', 'ok')
            return redirect(url_for('admin_contratacion', sec='requerimientos'))
        ...
        if accion == 'guardar_ingreso':
            ...
            oblig = [(dni,'DNI'),(nombre,'Trabajador'),(empresa,'Empresa'),(cargo,'Puesto/Cargo'),(area,'Área'),(fecha_ingreso,'Fecha ingreso'),(sistema_pensionario,'Sistema pensionario'),(estado_civil,'Estado civil')]
            ...
            with db() as con:
                ...
                if existe:
                    con.execute("""UPDATE trabajadores SET nombre=?, empresa=?, cargo=?, area=?, correo=?, celular=?, activo=1, fecha_ingreso=COALESCE(NULLIF(?,''),fecha_ingreso), observacion=?, foto_ruta=COALESCE(NULLIF(?,''),foto_ruta) WHERE dni=?""", (nombre,empresa,cargo,area,correo,celular,fecha_ingreso,obs,foto_ruta,dni))
    ...
    opt_ingresos=''.join([f"<option value='{h(r['dni'])}'>{h(r['dni'])} - {h(r['trabajador'])} - {h(r['requerimiento'])}</option>" for r in trabajadores_proceso])
    opt_req=''.join([f"<option value='{h(r['ticket'])}'>{h(r['ticket'])} - {h(r['sede'])} - {h(r['area'])} - {h(r['cargo'])}</option>" for r in requerimientos])
    def _estado_pill(v):
    ...
    def bandeja_operativa(tabla_id='tabla_embudo'):
        rows=[]
        for r in trabajadores_proceso[:300]:
            rows.append("<tr>"
              ...
              + "</tr>")
        body=''.join(rows) or "<tr><td colspan='13'>Aún no hay trabajadores registrados desde Nuevos/Reingresantes.</td></tr>"
        return f"""
...
@media(max-width:760px){
  ...
  .dash-hero h1{font-size:30px!important;}
    ...
    if sec=='dashboard':
        ...
        req_options=''.join([f"<option value='{h(r['ticket'])}'>{h(r['ticket'])} - {h(r['sede'])} / {h(r['actividad'])}</option>" for r in requerimientos])
        req_rows=''.join([f"<tr><td><b>{h(r['ticket'])}</b></td><td>{h(r['empresa'])}</td><td>{h(r['sede'])}</td><td>{h(r['area'])}</td><td>{h(r['actividad'])}</td><td>{h(r['fecha_ingreso'])}</td><td><span class='status-pill ok'>{h(r['estado'])}</span></td><td class='col-delete'><form method='post' onsubmit='return confirm(&quot;¿Eliminar ticket?&quot;)'><input type='hidden' name='accion' value='eliminar_requerimiento'><input type='hidden' name='req_id' value='{r['id']}'><button class='delete-mini' title='Eliminar'>Eliminar</button></form></td><td>{h(r['responsable'])}</td></tr>" for r in requerimientos]) or "<tr><td colspan='9'>Sin requerimientos registrados.</td></tr>"
        content=wrap(f'''
        <h2 class='c-title'>Requerimientos / Tickets de personal</h2>
        <div class='dash-hero' style='margin-bottom:18px'><div><h1>Ticket de contratación</h1><p class='muted2'>Primero crea el ticket por empresa, sede, área y actividad. Luego escanea DNI o código de barras en este mismo módulo para armar la base del requerimiento.</p></div><a class='c-btn' href='/admin/contratacion?sec=nuevos'>Completar ficha trabajador</a></div>
        <div class='req-pro-grid'>
          <form method='post' class='pro-card nice-form'><input type='hidden' name='accion' value='guardar_requerimiento'><h3 class='pro-section-title'>1) Datos del ticket / requerimiento</h3><b>Ticket</b><input name='ticket' required placeholder='Ej. REQ-2026-0001 / LABORES 29.08.2024'><b>Empresa</b><select name='empresa' required><option>AQUANQA</option><option>AQUANCA II</option><option>BLUEBERRIES PERÚ S.A.C.</option></select><b>Sede</b><select name='sede' required><option>Blueberries</option><option>Arato</option><option>Olmos</option><option>Packing</option><option>Administrativo</option><option>Otra sede</option></select><b>Área</b><select name='area' required><option>Campo</option><option>Packing</option><option>RRHH</option><option>Calidad</option><option>Almacén</option><option>Mantenimiento</option></select><b>Actividad</b><select name='actividad' required><option>OB_PODA / COSECHA</option><option>COSECHA</option><option>PACKING</option><option>SELECCIÓN</option><option>DESPACHO</option><option>ADMINISTRATIVO</option></select><b>Fecha ingreso objetivo</b><input type='date' name='fecha_ingreso' value='{hoy_iso()}' required><b>Prioridad</b><select name='prioridad'><option>ALTA</option><option selected>MEDIA</option><option>BAJA</option></select><b>Estado</b><select name='estado'><option>SOLICITADO</option><option>APROBADO</option><option>EN CONVOCATORIA</option><option>EN REGISTRO</option><option>EN PROCESO</option><option>CERRADO</option></select><b>Responsable</b><input name='responsable' placeholder='Responsable RRHH'><b>Detalle</b><textarea name='observacion' placeholder='Observación, perfil requerido, turno, condiciones o comentario.'></textarea><input type='hidden' name='cargo' value='POR DEFINIR'><input type='hidden' name='cantidad' value='0'><div class='actions'><button class='c-btn'>💾 Crear ticket</button><span class='muted2'>Cargo y cantidad se calculan/definen en el proceso posterior.</span></div></form>
          <form method='post' class='pro-card nice-form' id='form_scan_req'><input type='hidden' name='accion' value='registrar_dni_requerimiento'><h3 class='pro-section-title'>2) Escaneo masivo DNI / código de barras al ticket</h3><b>Ticket activo</b><select name='ticket_req' required><option value=''>Seleccione ticket</option>{req_options}</select><b>Modo lectura</b><select id='modo_scan_req'><option>Lector USB / teclado</option><option>Cámara celular / web</option><option>Código de barras DNI</option><option>Digitación manual</option></select><b>DNI / código</b><input id='dni_scan_req' name='dni_scan' required maxlength='12' autofocus placeholder='Escanee o digite DNI y presione ENTER'><b>Resultado</b><input id='scan_result_req' readonly value='Nuevo: guarda DNI / Reingresante: jala datos'><div class='full scan-box'><div class='scan-camera'><video id='videoScanReq' autoplay playsinline muted style='display:none'></video><span id='scanCamMsg'>Cámara preparada para escaneo masivo de DNI / código de barras</span></div><div class='scan-tools'><button type='button' class='c-btn gray' onclick='activarCamaraReq()'>📷 Activar cámara</button><button type='button' class='c-btn gray' onclick='apagarCamaraReq()'>Apagar cámara</button><button type='button' class='c-btn' onclick='agregarDniLocalReq()'>➕ Agregar leído</button><button type='button' class='c-btn' onclick='document.getElementById("form_scan_req").requestSubmit()'>💾 Guardar en base</button></div><div class='scan-counter'><span id='cntLeidos'>Leídos: 0</span><span>Nuevo: DNI base</span><span>Reingreso: datos enlazados</span></div><div id='listaScanReq' class='mini-list'></div><p class='muted2'>El lector USB escribe el DNI como teclado. Para cámara web/celular queda preparada la pantalla masiva; en producción se integra librería JS de barcode/QR o servicio local.</p></div></form>
        </div>
        <div class='c-filter'><b>Filtros</b><input oninput="filtrarTabla(this,'tabla_req')" placeholder='Buscar ticket, sede, área, estado...'><span></span><span></span></div><div class='c-card table-wrap'><table id='tabla_req' class='c-table clean-table'><tr><th>Ticket</th><th>Empresa</th><th>Sede</th><th>Área</th><th>Actividad</th><th>Ingreso</th><th>Estado</th><th>Eliminar</th><th>Responsable</th></tr>{req_rows}</table></div>
        <script>
        let scanReqStream=null, scanReqCount=0;
        function limpiarDniReq(v){{return (v||'').replace(/\D/g,'').slice(-8);}}
        document.addEventListener('DOMContentLoaded',()=>{{const i=document.getElementById('dni_scan_req'); if(i){{i.addEventListener('keydown',function(e){{if(e.key==='Enter'){{e.preventDefault(); agregarDniLocalReq();}}}});}}}});
        function agregarDniLocalReq(){{const i=document.getElementById('dni_scan_req'); const dni=limpiarDniReq(i.value); if(dni.length!==8){{alert('DNI debe tener 8 dígitos.');return;}} i.value=dni; scanReqCount++; document.getElementById('cntLeidos').innerText='Leídos: '+scanReqCount; document.getElementById('scan_result_req').value='DNI '+dni+' agregado al ticket activo'; const box=document.getElementById('listaScanReq'); const row=document.createElement('div'); row.innerHTML='<b>'+dni+'</b><span>Listo para guardar / completar ficha</span><small>'+new Date().toLocaleTimeString()+'</small>'; box.prepend(row); i.select();}}
