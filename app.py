...
.c-table th,.c-table td{vertical-align:middle!important}.c-table .action-delete,.action-delete{font-size:16px!important;min-width:38px!important;height:34px!important;padding:4px 8px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;}
    ...
    if session.get('admin_id'):
        ...
        <div id='grp_contratacion' data-group='contratacion' class='menu-group force-open'>
          ...
          <div class='submenu'>
            ...
            <a class='{cls('capacitacion')}' onclick='saveSideScroll()' href='/admin/contratacion?sec=capacitacion'><span>🎥</span><span class='label'>Capacitación</span></a>
...
def admin_contratacion():
    ...
    if request.method=='POST':
        ...
        if accion == 'guardar_requerimiento':
            ...
            if not sede or not area or not cargo or not actividad or cantidad <= 0:
                flash('Completa sede, área, cargo, actividad y cantidad mayor a 0.', 'error')
...
.compact-form{display:grid!important;grid-template-columns:170px minmax(180px,1fr) 170px minmax(180px,1fr)!important;gap:12px 18px!important;align-items:center!important}.compact-form textarea{min-height:76px}.compact-form b{font-size:13px;color:#334155!important}.table-wrap{overflow:auto!important}.icon-btn{border:0;background:#ecfdf5!important;color:#047857!important;border-radius:10px;padding:7px 9px;cursor:pointer}.icon-btn:hover{background:#bbf7d0!important}.c-form input[type=file]{padding:9px!important}@media(max-width:900px){.compact-form{grid-template-columns:1fr!important}.compact-form b{margin-top:6px}}</style>"""
    ...
    if sec=='dashboard':
        ...
        content=wrap(f"""
        <h2 class='c-title'>Inducción y cursos</h2><div class='dash-hero' style='margin-bottom:18px'><div><h1>Inducción y cursos</h1><p class='muted2'>Administrador carga videos y asigna cursos; la evaluación queda para el usuario trabajador en celular.</p></div><a class='c-btn' href='/admin/contratacion?sec=firma'>Ir a firma</a></div>
