        ...
        if accion == 'marcar_visto_masivo':
            ...
            if not ids:
                ...
                with db() as con:
                    ...
                    con.commit()
                flash(f'Se cambió el estado a {nuevo_estado} para {len(ids)} registro(s).', 'ok')
            return redirect(url_for('admin_contratacion', sec=destino))
