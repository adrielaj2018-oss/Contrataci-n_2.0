  ...
  .dash-hero h1{font-size:30px!important;}
    ...
    if sec=='dashboard':
        ...
        async function agregarDniLocalReq(){{
          ...
          if(!ticket){{alert('Seleccione ticket activo.');return;}}
